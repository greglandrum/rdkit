...
struct Trajectory_wrapper {
  static void wrap() {
    python::class_<Trajectory>(
        ...
        python::no_init)
        .def(
            "Dimension", &Trajectory::dimension, (python::arg("self")),
        ...
        .def(
            ...
            "snapshotNum, "
            "where the latter is the zero-based index of the Trajectory's "
            "Snapshot "
            "before which the Snapshot s will be inserted; returns the "
            "zero-based "
        ...
        .def("AddConformersToMol", &Trajectory::addConformersToMol,
             ...
             "defaults to -1 (all)\n");
    python::def(
        "Trajectory", constructTrajectory_wrap,
        ...
        python::return_value_policy<python::manage_new_object>());
    python::def("Trajectory", copyConstructTrajectory_wrap,
                (python::arg("other")), "Copy constructor",
                python::return_value_policy<python::manage_new_object>());
