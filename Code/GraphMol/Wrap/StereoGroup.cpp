...
StereoGroup *createStereoGroup(StereoValType typ, ROMol &mol,
...
struct stereogroup_wrap {
  static void wrap() {
    ...
    python::class_<StereoGroup, boost::shared_ptr<StereoGroup>>(
        ...
        .def("GetStereoVal", &StereoGroup::getStereoVal,
             "Returns the StereoValType.\n")
    ...
    python::def("CreateStereoGroup", &createStereoGroup,
                ...
                "of atom Ids",
                (python::arg("StereoValType"), python::arg("mol"),
                 python::arg("atomIds")),
